        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="5acrylique.php" class="list-group-item active">Acrylique</a>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <img class="img-responsive" src="img\tirage\acrylique.jpg" alt="" style="width: 400px;">
                    <div class="caption-full">
                        <h4 class="pull-right">$24.99</h4>
                        <h4><a href="#">Product Name</a>
                        </h4>
                        <p>Imprimez vos plus beaux clichés directement sous une très fine plaque de plexi. Le verre confère à vos photos une brillance exceptionnelle.
Les bords polis renforcent l'effet de profondeur et font de votre photo, vue de côté, un véritable petit bijou. Vos plus belles photos se transforment ainsi en précieuses œuvres d'art.
En outre, vous pouvez personnaliser vos photos avec vos textes et les disposer librement.
Placez votre photo où bon vous semblera grâce au support, lui aussi en plexi. La lumière entrant par l'arrière illumine les couleurs de vos photos pour un effet époustouflant.</p>
                        </div>
                    <div class="ratings">
