        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="1tirage.php" class="list-group-item">Tirage classique</a>
                    ...
                    <a href="6panorama.php" class="list-group-item active">Panoram 3</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <img class="img-responsive" src="img\tirage\panorama.jpg" alt="" style="width: 400px;">
                    <div class="caption-full">
                        <h4 class="pull-right">$24.99</h4>
                        <h4><a href="#">Product Name</a>
                        </h4>
                        <p>Pourquoi ne pas opter pour le panorama photo et imprimer vos plus belles images dans un format de haute qualité, qui peut idéalement se placer dans un cadre, pour orner votre salon, votre chambre ou votre cuisine ? Le panorama  vous est proposé  en 16:9, panoramique, carré en encore 4:3. Après avoir choisi le format, il vous suffit de sélectionner la photo que vous voulez imprimer, et de la positionner sur votre poster. Vous validez, et vous recevez votre panorama sous quelques jours !                         </p>
                        </div>
                    <div class="ratings">
