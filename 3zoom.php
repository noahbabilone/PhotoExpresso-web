    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
            ...
            <li><a href="presentation.php">Qualité</a></li>
            <li><a href="team.php">Qui Sommes Nous ?</a></li>
 ...
 <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                   <a href="1tirage.php" class="list-group-item ">Devloppement Photo</a>
                    ...
                    <a href="3zoom.php" class="list-group-item active">Zoom</a>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <img class="img-responsive" src="img/tirage/enlargement.jpg" alt="" style="width: 400px;">
                    <div class="caption-full">
                        <h4 class="pull-right">$24.99</h4>
                        <h4><a href="#">Product Name</a>
                        </h4>
                        <p> les agrandissements photos sont tirés sont tirés sur minilab, par projection et procédé argentique sur du papier FUJI Crystal Archive Suprême. Ce papier photo argentique épais avec une forte résistance à la décoloration, garantit des tirages d’une haute qualité et d’une grande longévité.

Les agrandissements photos sont disponibles en Mat ou Brillant, avec ou sans marge blanche.
</p>
