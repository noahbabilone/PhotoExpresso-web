<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">Photo
            <sapn class="text-primary">Expresso</sapn></a>
    </div>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="commandes.php">Afficher toutes</a></li>
                        <li><a href="#">En cours de validation</a></li>
                        <li><a href="#">En attente de paiement</a></li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="#" alt="" title="Tous les produits">Tous les Produits</a></li>
                        <li>
                            <a href="#">Gestion des produis <span class="fa arrow"></span></a>
